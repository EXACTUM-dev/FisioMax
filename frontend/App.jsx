  ...
  return (
    <>
      ...
      <Routes>
        ...
        {/* Wildcard /* is required so Clerk's internal sub-routes
          (e.g. /login/verify-email-address, /register/verify-email-address)
          are handled by these pages instead of falling into the catch-all. */}
