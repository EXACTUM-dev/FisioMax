...
describe("Historia de Usuario: Envío de Solicitudes de Membresías", () => {
  ...
  describe("Escenario 3: Validación de campos completos y tipo de documentos", () => {
    ...
    test("debería validar que todos los campos obligatorios estén completos según el UML", async () => {
      ...
      expect(screen.getByTestId("apellido-p-input")).toHaveAttribute("required");
      expect(screen.getByTestId("apellido-m-input")).toHaveAttribute("required");
      ...
      expect(screen.getByTestId("redes-sociales-input")).toHaveAttribute("required");
      ...
      expect(screen.getByTestId("codigo-postal-input")).toHaveAttribute("required");
      ...
      expect(screen.getByTestId("constancia-input")).toHaveAttribute("required");
    });
  ...
  describe("Escenario 6: Sistema registra solicitud exitosamente", () => {
    ...
    test("debería registrar la solicitud cuando todos los campos son válidos según el UML", async () => {
      ...
      await user.type(screen.getByTestId("correo-input"), "juan.garcia@ejemplo.com");
      await user.type(screen.getByTestId("telefono-input"), "5551234567");
      await user.type(screen.getByTestId("redes-sociales-input"), "@juangarcia");
      ...
      await user.type(screen.getByTestId("titulo-input"), "Lic. en Fisioterapia");
  ...
  describe("Casos de prueba adicionales", () => {
    ...
    test("debería manejar múltiples archivos de documentación", async () => {
      ...
      const file1 = new File(['contenido1'], 'documento1.pdf', { type: 'application/pdf' });
      const file2 = new File(['contenido2'], 'documento2.jpg', { type: 'image/jpeg' });
