...
const CloseButton = ({ 
  ...
  // Clases base
  const baseClasses = "absolute flex items-center justify-center font-normal border-0 bg-transparent hover:bg-gray-100 text-gray-500 hover:text-gray-700 rounded-full transition-colors duration-200 cursor-pointer z-60 focus:outline-none focus:ring-2 focus:ring-gray-300 focus:ring-opacity-50";

  // Clases de posicionamiento
  const positionClasses = `${position.top || ""} ${position.right || ""} ${position.left || ""} ${position.bottom || ""}`;
